...
if ($type==3)
{
 ...
 <input type='submit' value='Добивить'></p>
 </form>";
}
...
if ($type==4)
{
 ...
 $tar=$_GET["tar"];
 $miks=$_GET["bord"];
 $query=mysql_query("INSERT INTO users (id ,fio ,telefon ,adres ,login ,pass ,tarif ,miks, status) VALUES (NULL , '$name', '$telefon', '$adres', '$login', '$pass', '$tar', '$miks', 'no');");
};
...
<a href='users.php?type=5'>Внести платеж</a>&nbsp;&nbsp;
<a href='users.php?type=7'>Изменить тариф</a";
include('podval.php');
?>